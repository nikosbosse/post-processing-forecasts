...
#     # By default cv_init_training is equal to NULL and therefore equal to the complete
#     # data. e.g. by default no split in training and validation set
...
#       if (method == "cqr_multiplicative") {
#         quantiles_low_updated <- c(
#           quantiles_low_updated, (quantiles_low[cv_init_training + 1] * cqr_results$margin_lower)
#         )
#         quantiles_high_updated <- c(
#           quantiles_high_updated, (quantiles_high[cv_init_training + 1] * cqr_results$margin_upper)
#         )
#       } else {
#         quantiles_low_updated <- c(
#           quantiles_low_updated, (quantiles_low[cv_init_training + 1] - cqr_results$margin_lower)
...
#     df, model, location, target_type, horizon, quantile, quantiles_low_updated,
#     quantiles_high_updated
#   )
#
