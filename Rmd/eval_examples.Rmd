...
```{r}
df_eval <- eval_methods(uk_combined, summarise_by = "model")
eval_methods(uk_combined, summarise_by = "target_type")
eval_methods(uk_combined, summarise_by = "horizon")
eval_methods(uk_combined, summarise_by = "quantile")
...
```{r}
eval_methods(uk_combined, summarise_by = c("model", "target_type"))
eval_methods(uk_combined, summarise_by = c("model", "horizon"))

df_eval <- eval_methods(uk_combined, summarise_by = c("horizon", "target_type"))
plot_eval(df_eval)
```
...
eval_methods(uk_combined, summarise_by = "model")
eval_methods(uk_combined, summarise_by = "target_type")
