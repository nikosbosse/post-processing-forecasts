...
df_save <- cross_validation(df=df, models=c("epiforecasts-EpiExpert"),
                            method="cqr", training_lengths=c(40)) #seq(40,73,1)
...
```{r}
# unique(df$model)
df_forecast <- cross_validation_forecasting(df=df, models=c("epiforecasts-EpiExpert"),
                            locations = c("iT"),
                            method="cqr", 
                            training_lengths=c(10,11)) #seq(40,73,1)
df_forecast
