...
```{r}
plot_intervals(df = df_combined, model = "epiforecasts-EpiExpert", target_type = "Cases",
...
extract_validation_set <- function(df_combined){
  ...
  validation_set_target_end_date <- sorted_unique_target_end_dates[seq(cv_init_training+1,length(sorted_unique_target_end_dates))]
