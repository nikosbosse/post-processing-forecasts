...
df_updated <- update_predictions(df = df, methods = "cqr", models = model, locations = "GB",
                                 horizons = 1)
...
# Updating Predictions
df_updated <- update_predictions(df = df, methods = "cqr", models = model, locations = "GB", target_types = "Cases", cv_init_training = 5)
