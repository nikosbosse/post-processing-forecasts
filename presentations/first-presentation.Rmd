...
<!-- Before: Part of ongoing research project by the **epiforecasts** group of the London School of Hygiene & Tropical Medicine that our project partner Nikos Bosse is actively part of due to his PHD in Epidemiology > -->
...
- Idea: Compare human forecasts from humans with model-based predictions
...
<!-- Remove Chunk Option 'eval=FALSE' when code is compatible with updated functions -->
...
```{r fig.height=4, echo=FALSE, eval=FALSE}
plot_intervals_grid(df_combined, model, facet_by = "quantile", quantiles = c(0.05, 0.1, 0.25))
```
