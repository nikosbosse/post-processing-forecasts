...
- For many categories the magnitudes of the relative change in are difficult to compare in table output

- Visualize table either with as barplot or as heatmap
