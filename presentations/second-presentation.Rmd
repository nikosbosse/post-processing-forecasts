...
- Advantages of Median basis: spreads independent of quantile number and non-symmetric adjustments possible

- Risks: quantile crossing
...
u_{i,j}^* = u_{i,j} + (m-u_{i,j}) \cdot w_i 
\end{aligned}
$$
...
```{r uk-qsa-plots1, echo=FALSE, fig.height=5}
plot_intervals_grid(
  uk_qsa_uniform,
