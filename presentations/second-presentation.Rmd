...
As optimization method we use the quasi-Newton method **BFGS**.
...
.left-30[ 
- Does QSA improve the Weighted Interval Score? What adjustments does it make?
...
--
#TODO: How can we put the tables below next to each other?
.right-65[

Aggregated over all time series:
...
```{r hub-qsa-plots1, echo=FALSE, fig.height=3, cache=cache}
