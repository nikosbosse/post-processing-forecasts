...
We apply post processing methods to human forecasts from the [UK Covid-19 Crowd Forecasting Challenge](https://www.crowdforecastr.org/2021/05/11/uk-challenge/) as well as model based forecasts provided by the [European Covid-19 Forecast Hub](https://covid19forecasthub.eu/index.html). Using these datasets we examine the contributions post-processing techniques can provide and there effects among varying *models*, *target types* such as cases and deaths, forecasting *horizons* and *quantiles*.
