...
<!-- TODO: Describe most important columns of the data set such as horizon and target_type since we refer to these columns frequently -->
...
$$
\begin{aligned}
Score_\alpha(y) = (u-l) + \frac{2}{\alpha} \cdot (l-y) \cdot \mathbbm{1} (y \leq l) + \frac{2}{\alpha} \cdot (y-u) \cdot \mathbbm{1}(y \geq u).
\end{aligned}
$$ 
<!--  --> 
