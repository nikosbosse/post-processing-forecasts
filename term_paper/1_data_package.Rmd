...
Thus, as the name suggests, the Weighted Interval Score is a weighted sum of the individual Interval Scores.^[As the WIS is based on interval scores, the scores of symmetric quantiles are always identical, e.g. each quantile plot depicting scores will always be symmetric around the median.]
