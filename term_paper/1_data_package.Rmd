...
The WIS combines measures for interval *sharpness* as well as *overprediction* and *underprediction*.
It can thus be understood as a trade-off between prediction *accuracy* and *precision*.
...
The process is nicely illustrated in \Cref{fig:ch1-cv}^[Image Source: https://otexts.com/fpp3/tscv.html].
