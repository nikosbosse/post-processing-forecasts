...
Overall the score differences across models appear to be smoothed out which also results from the regularization component that is unique to the multiplicative modification.
...
The trend of \Cref{fig:ch2-uk-cqr3-intervals} can be observed in a similar fashion across many different feature combinations: 
Starting from huge intervals in the naive implementation, the effect of downscaling the score vectors tends to be too extreme.
