...
```{r, qsa-quantiles-model-groups-target-types-best, echo=FALSE, fig.cap="QSA Flexible overfits as its intervals are too low in the training and too high in the validation set."}
b <- "black"
t <- "transparent"
