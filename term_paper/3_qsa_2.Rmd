...
Breaking down the results by the forecasting `horizon` also reveals notable patterns. Figure \Cref{fig:qsa-methods-horizons} plots the WIS changes across horizons for all three methods. Across all QSA methods the improvements to the WIS increase with the `horizon`. The gains are primarily visible for the three and four week ahead predictions. In Contrast the increases in score and overfitting are primarily located at a horizon of one. 

```{r, qsa-methods-horizons, echo=FALSE, out.width="80%", fig.cap="QSA methods improve forecasts more for larger horizons. For smaller horizons they tend to voerfit, this is especially the case with QSA Flexible."}
