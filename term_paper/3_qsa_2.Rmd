...
```{r, qsa-all-methods-target-types, echo=FALSE, out.width="70%", fig.cap="Across both Target Types all QSA methods improve the WIS."}
df_target <- eval_methods(uk_qsa, summarise_by = "target_type") |>
  select(target_type, qsa_uniform, qsa_flexible_symmetric, qsa_flexible)

plot_eval(df_target, base_size = 8) + labs(x = NULL, y = NULL)
```
