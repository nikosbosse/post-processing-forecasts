...
#TODO: add empty spaces, less bliock text.
```
...
```{r, qsa_uniform-val-set, echo=FALSE}
...
tab_uniform #TODO: put inline computation in r chunk and name variables to then call in inline code so that its better readable and compiles
```
...
```{r, qsa_flexible_symmetric-val-set, echo=FALSE}
...
```{r, qsa_flexible_symmetric-hor-quant, echo=FALSE, out.width="80%", fig.cap="QSA Flexible Symmetric overfits Quantiles at short Horizons"}
...
```{r, qsa_flexible-val-set, echo=FALSE}
