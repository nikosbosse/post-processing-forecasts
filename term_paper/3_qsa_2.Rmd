...
display_table(tab_uniform, caption="QSA Uniform improves WIS by increasing interval widths.", bold_header = TRUE, striped = FALSE)
```
...
display_table(tab_flexible_symmetric, caption="QSA Flexible_Symmetric improves WIS by increasing interval widths.", bold_header = TRUE, striped = FALSE)
```
